...
# =====================================================================
# 1. CONTEXTO Y ENTENDIMIENTO
# =====================================================================

Write-Heading "1. Contexto y entendimiento del proyecto" 1

Write-Heading "1.1. Situacion actual" 2
...
Write-Heading "1.2. Detonante del proyecto" 2
...
Write-Heading "1.3. Vision arquitectonica" 2
...
# =====================================================================
# 2. BLOQUES DEL PROYECTO
# =====================================================================

Write-Heading "2. Bloques funcionales del proyecto" 1
...
Write-Heading "2.1. Bloque 1 - Nuevo portal Irekia (Irekia Berria)" 2
...
Write-Heading "2.2. Bloque 2 - Sistema de gestion de Transparencia" 2
...
Write-Bold "Decisiones pendientes:"
...
Write-Heading "2.3. Bloque 3 - Sistema de gestion de Participacion" 2
...
Write-EmptyLine
Write-Bold "a) Participacion formal (asociada a normativa):"
...
Write-EmptyLine
Write-Bold "b) Participacion informal / voluntaria:"
...
Write-Heading "2.4. Bloque 4 - Sistema de gestion de Prensa y Comunicacion Institucional" 2
...
# --- BLOQUE 5: DIASPORA ---
Write-Heading "2.5. Bloque 5 - Diaspora (Sedes vascas en el extranjero)" 2
...
Write-Bold "Problematica especifica:"
...
# --- BLOQUE 6: DISENO ---
Write-Heading "2.6. Bloque 6 - Sistema de diseno y aplicacion en euskadi.eus" 2
...
Write-Bold "Organizacion prevista:"
...
Write-Heading "3. Mapa de sistemas y flujos de publicacion" 1
...
Write-EmptyLine
Write-Bold "Sistema de gestion de Transparencia"
...
Write-EmptyLine
Write-Bold "Sistema de gestion de Participacion"
...
Write-EmptyLine
Write-Bold "Sistema de gestion de Prensa"
...
Write-EmptyLine
Write-Bold "Entidades y cargos publicos"
...
Write-Heading "4. Restricciones y condicionantes tecnicos" 1
...
Write-Heading "5. Dudas abiertas y decisiones pendientes" 1

Write-Heading "5.1. Sobre Transparencia" 2
...
Write-Heading "5.2. Sobre Participacion" 2
...
Write-Heading "5.3. Sobre Prensa y Comunicacion" 2
...
Write-Heading "5.4. Sobre Diaspora" 2
...
Write-Heading "5.5. Sobre Diseno" 2
...
Write-Heading "5.6. Sobre Organizacion y Gobierno del Proyecto" 2
...
Write-Heading "5.7. Sobre Entidades y Cargos Publicos" 2
...
Write-EmptyLine
Write-Bold "Paso 2 - Resolucion de dudas criticas"
...
Write-EmptyLine
Write-Bold "Paso 3 - Levantamiento funcional por bloque"
...
Write-EmptyLine
Write-Bold "Paso 4 - Definicion tecnica de alto nivel"
...
Write-EmptyLine
Write-Bold "Paso 6 - Planificacion"
...
Write-Heading "7. Resumen ejecutivo" 1
...
Write-Bold "Barra de participacion (persistente en todas las secciones):"
...
Write-Bold "Sidebar derecho (en secciones de noticias):"
...
Write-Bold "Banners laterales (sidebar en participacion):"
...
Write-Bold "Propuestas de Gobierno (/es/debates):"
...
Write-Bold "Peticiones Ciudadanas (/es/proposals):"
...
Write-Bold "Respuestas del Gobierno (/es/answers):"
...
Write-Bold "Encuestas (/es/surveys):"
...
Write-Bold "1. Francia - Haute Autorite pour la Transparence de la Vie Publique (hatvp.fr)"
...
Write-EmptyLine
Write-Bold "2. Reino Unido - data.gov.uk + GOV.UK Transparency"
...
Write-EmptyLine
Write-Bold "3. Finlandia - Suomi.fi + opendata.fi + Tutkihallintoa.fi"
